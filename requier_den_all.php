...
$query = "SELECT * FROM den WHERE name = '$name'";

$result = mysqli_query($conn, $query);

$query_2 = "SELECT * FROM money_1 WHERE name = '$name' ";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container">
            ...
            <a href="export_all_den.php"><button class='btn btn-success' type="button">export</button></a>
            <table class="table">
...
endwhile;
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $total - $priceMinus; ?></td>
