...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM buy WHERE date2 LIKE '%$search_trim%' and users_id = '$id' LIMIT $start_from, $num_per_page";
} else {
    $query = "SELECT * FROM buy where users_id = '$id' LIMIT $start_from, $num_per_page";
}
...
if (isset($_POST["delete"])) {
    $id = $_POST["id"];
    $query_delete = "DELETE FROM buy WHERE id = '$id'";
    mysqli_query($conn, $query_delete);
    header("Location:allBuyYear.php");
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div><?php
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    echo '<button class="btn btn-dark m-2"><a class="sp" href="allBuyYear.php?page=' . $i . '">' . $i . '</a></button>';
                }
