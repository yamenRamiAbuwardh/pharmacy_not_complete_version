...
if (isset($_POST['search'])) {
    ...
    $trim_search_key = trim($search_key);
    $query = "SELECT * FROM buy WHERE users_id = '$id' AND date2 LIKE '%$trim_search_key%' LIMIT $start_from, $num_per_page";
} else {
    $date = date("m");
    $query = "SELECT * FROM buy WHERE month <= '$date' and users_id = '$id'  LIMIT $start_from, $num_per_page";
}
...
if (isset($_POST["delete"])) {
    ...
    header("Location:allBuyMonth.php");
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                    <div class="input-group">
                        <input type="text" class="form-control bg-light border-0 small" placeholder="البحت عن طريق التاريخ " name='search'>
...
<input type="hidden" name="id" value="<?php echo $row['id']; ?>">
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                echo '<button class="btn btn-dark m-2"><a class="sp" href="allBuyMonth.php?page=' . $i . '">' . $i . '</a></button>';
